...
public class ItemJpa implements java.io.Serializable {
    ...
    @SequenceGenerator(name = "${package}.persistence.jpa.model.ItemJpaIdGenerator", sequenceName = "S_ITEM_ID")
    @Id
    @GeneratedValue(strategy = SEQUENCE, generator = "${package}.persistence.jpa.model.ItemJpaIdGenerator")
